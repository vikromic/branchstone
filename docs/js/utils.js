...
export const copyToClipboard = async (text) => {
  try {
    ...
    if (navigator.clipboard && navigator.clipboard.writeText) {
      ...
      // Fallback for older browsers (check if execCommand is supported)
      if (document.queryCommandSupported && !document.queryCommandSupported('copy')) {
        console.warn('[Utils] copyToClipboard: copy command not supported');
        return false;
      }
      ...
      try {
        ...
        console.error('[Utils] copyToClipboard: execCommand failed:', err);
      }
    ...
    console.error('[Utils] copyToClipboard: Failed to copy to clipboard:', error);
    return false;
  }
};
